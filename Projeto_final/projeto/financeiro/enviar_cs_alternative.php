        ...
        <form enctype="multipart/form-data" action="" method="POST">
            <br><br><br><br>
                ...
                <p><label class="aviso">Por favor, selecione um arquivo</label><br>
                    ...
                    <input type="text" id="cliente" name="cliente"  style="border-radius: 5px; outline: none; width: 25%; margin: 1px; border: none; letter-spacing: 2px; font-size: 16px; padding: 0 15px;" autocomplete="off" placeholder="Cliente" required ><br><br>
