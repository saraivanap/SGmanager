...
<body style="text-align: center;">
    ...
    <header class="site-header sticky-top py-1 bg-dark text-white ">
        ...
        <h4 style="margin-right: 36%">Lista de contrato com Fornecedores</h4>

        </nav>
      </header>
    <br>
      <table class="table table-bordered table-Light .table-striped" style="text-align: center;">
        <thead>
          <tr>
                <th scope="col">ID</th>
        ...
        <?php
                ...
                <tr>
                    ...
                    <td><?php echo $arquivo['fornecedor'];?></td>
