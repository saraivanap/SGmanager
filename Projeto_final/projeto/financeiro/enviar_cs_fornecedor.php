<?php
   ...
   if(!empty($_GET['id'])){
    ...
    if(isset($_FILES['arquivo'])){
        ...
        if($deu_certo){
            $conexao ->query ("INSERT INTO formulario.contrato_fornecedor (nome, data_upload, path, fornecedor) VALUES('$nomeDoArquivo', NOW(),'$path', '$fornecedor' )") or die ($conexao->error);
            echo "<br>";
        ...
        <form enctype="multipart/form-data" action="" method="POST">
            <br><br><br>
                ...
                <p><label class="aviso">Por favor, selecione um arquivo</label><br>
                    ...
                    <input type="text" id="fornecedor" name="fornecedor" style="border-radius: 5px; outline: none; width: 25%; margin: 1px; border: none; letter-spacing: 2px; font-size: 16px; padding: 0 15px;" autocomplete="off" placeholder="Fornecedor" required value="<?php echo $fornecedor?>"><br><br>
