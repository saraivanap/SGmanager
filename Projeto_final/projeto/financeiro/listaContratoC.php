...
<body style="text-align: center;">
    ...
    <header class="site-header sticky-top py-1 bg-dark text-white ">
        ...
        <h4 style="margin-right: 35%">Lista de contrato com Clientes</h4>
      ...
      <table class="table table-bordered table-hover" style="text-align: center;">
        ...
        <?php
                ...
                <tr>
                    ...
                    <td><?php echo $arquivo['cliente'];?></td>
                    <td><?php echo $arquivo['nome'];?></td>
                    <td><?php echo date("d/m/Y", strtotime($arquivo['data_upload']));?></td>
                    <td><a class="bt" target="_self" href="<?php echo $arquivo['path'];?>"><?php echo $arquivo['nome'];?></a></td>
                </tr>
                <?php
                }
                ?>
