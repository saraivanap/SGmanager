<?php
  ...
  $item = array(
    0=> array(
      'nome' => 'contrato.docx',
      'file' => 'financeiro/cs/contrato.docx',
      'titulo' => 'Modelo.contrato',
      'tipo' => 'docx'
    )
  )
?>
...
<body>
      ...
      <div class="col-lg-8 mx-auto p-4 py-md-5">
        ...
        <main>
          <h1 class="text-body-emphasis">Modelo de Contrato de Serviço</h1>
          <p class="fs-5 col-md-8">Baixe o modelo disponível no formato .docx clicando no botão abaixo para gerar um novo Contrato de Serviço.</p>
       ...
       <?php foreach($item as $item):?>
          <div class="mb-5">
              ...
              <a  href="<?php echo 'download.php?file='.$item['file']. '&nome='.$item['nome'].'&tipo='.$item['tipo']?>" class="btn btn-primary btn-lg px-4">
        ...
        <?php endforeach; ?>
          ...
          <div class="row g-5">
            <div class="col-md-6">
              <h2 class="text-body-emphasis">Contrato de Serviço</h2>
              <p>Faça o Upload do documento clicando no botão abaixo.</p>
              <ul class="list-unstyled ps-0">
                <li>
                <a href="enviar_cs_alternative.php" class="btn btn-primary btn-lg px-4">
        ...
        <?php
                        while($user_data = mysqli_fetch_assoc($result)){
                            ...
                            if($user_data['status_cliente'] == "Ativo"){
                               ...
                               echo "<td>
                                <a class = 'btn btn-primary btn-sm' href='enviar_cs.php?id=$user_data[id]'>
                                  <svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' fill='currentColor' class='bi bi-cloud-upload-fill' viewBox='0 0 16 16'>
                                    <path fill-rule='evenodd' d='M8 0a5.53 5.53 0 0 0-3.594 1.342c-.766.66-1.321 1.52-1.464 2.383C1.266 4.095 0 5.555 0 7.318 0 9.366 1.708 11 3.781 11H7.5V5.707L5.354 7.854a.5.5 0 1 1-.708-.708l3-3a.5.5 0 0 1 .708 0l3 3a.5.5 0 0 1-.708.708L8.5 5.707V11h4.188C14.502 11 16 9.57 16 7.773c0-1.636-1.242-2.969-2.834-3.194C12.923 1.999 10.69 0 8 0zm-.5 14.5V11h1v3.5a.5.5 0 0 1-1 0z'/>
                                  </svg>
                                </a>
