<?php
    ...
    if(!empty($_GET['search'])){
        ...
        $data = $_GET['search'];
        $get = "SELECT * FROM formulario.ordem_de_servico WHERE Nº_OS LIKE'%$data%' or responsavel LIKE '%$data%'
        ORDER BY Nº_OS DESC";
    }else{
        
        $get = "SELECT * FROM formulario.ordem_de_servico ORDER BY Nº_OS DESC";
    }
