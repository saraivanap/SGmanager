<?php
  ...
  if(!empty($_GET['search'])){
    ...
    $sql = "SELECT * FROM formulario.fornecedor WHERE id LIKE '%$data%' or id_fornecedor LIKE '%$data%' or fornecedor LIKE '%$data%' ORDER BY id DESC";
...
<body>
  ...
  <script>
    ...
    search.addEventListener("keydown", function(event){
      ...
      function searchData() {
        window.location = "view.listaF.adm.php?search="+search.value;
